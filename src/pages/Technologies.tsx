...
type StackColor = "blue" | "purple" | "cyan" | "pink" | "green" | "orange";

interface TechnologyStack {
    readonly title: string;
    readonly icon: ReactNode;
    readonly color: StackColor;
    readonly items: readonly string[];
}

const stacks: readonly TechnologyStack[] = [
    {
        title: "Languages",
        icon: (
...
const colorClasses: Record<StackColor, { readonly icon: string; readonly bg: string; readonly border: string; readonly tag: string }> = {
    blue: {
