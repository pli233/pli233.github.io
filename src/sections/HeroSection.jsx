...
export default function HeroSection() {
    ...
    return (
        <section id="home" className="min-h-screen pt-20 sm:pt-24 flex flex-col">
            <div className="section-container flex-grow flex items-center">
            ...
            <div className="-mt-8 pb-4 flex justify-center">
                <button
                    ...
                    className="flex flex-col items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors animate-bounce"
